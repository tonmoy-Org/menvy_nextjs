...
import { User, Mail, Phone, MapPin, Calendar, Shield, Edit, Save, X, TrendingUp, Lock } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Manage your account settings and view your performance</p>
          </div>
          {!isEditing ? (
            <Button onClick={() => setIsEditing(true)} className="bg-sky-300 hover:bg-sky-400 text-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{stats.thisMonthSales}</div>
